  ...
  def complete
    ...
    when OpenID::Consumer::SUCCESS
      ...
      if (token)
        ...
        @profile_data = myspace.get_person(@user_id,params={:fields=>'@all'})
        @friends_data = myspace.get_friends(@user_id,params={:fields=>'@all'})
        @album_data = myspace.get_albums(@user_id,params={:fields=>'@all'})
        @cats=myspace.get_video_supportedcategories(@user_id)
       end
