...
class OauthController < ApplicationController
  ...
  def start_auth
    ...
    request_token = myspace.get_request_token(callback_url+'?oauthreturn=true')
  ...
  def callback
    ...
    access_token = myspace.get_access_token(nil,params={:oauth_verifier=>verifier})
  ...
  def profile
    ...
    @profile_data = myspace.get_person(@user_id,:fields=>'@all')
